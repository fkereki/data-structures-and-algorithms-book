...
console.log(distance(undirected2, 0));
console.log(distance(undirected2, 1));
console.log(distance(undirected2, 2));
console.log(distance(undirected2, 3));
console.log(distance(undirected2, 4));
console.log(distance(undirected2, 5));
console.log(distance(undirected2, 6));
